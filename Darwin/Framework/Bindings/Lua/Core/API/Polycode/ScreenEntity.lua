...
ScreenEntity.POSITION_TOPLEFT = 0
ScreenEntity.POSITION_CENTER = 1
function ScreenEntity:__getvar(name)
	...
	elseif name == "width" then
		return Polycore.ScreenEntity_get_width(self.__ptr)
	elseif name == "height" then
		return Polycore.ScreenEntity_get_height(self.__ptr)
	end
...
function ScreenEntity:__setvar(name,value)
	if name == "hasFocus" then
	...
	elseif name == "processInputEvents" then
		...
		return true
	elseif name == "width" then
		Polycore.ScreenEntity_set_width(self.__ptr, value)
		return true
	elseif name == "height" then
		Polycore.ScreenEntity_set_height(self.__ptr, value)
		return true
	end
...
function ScreenEntity:Clone(deepClone, ignoreEditorOnly)
	local retVal = Polycore.ScreenEntity_Clone(self.__ptr, deepClone, ignoreEditorOnly)
...
function ScreenEntity:applyClone(clone, deepClone, ignoreEditorOnly)
	local retVal = Polycore.ScreenEntity_applyClone(self.__ptr, clone.__ptr, deepClone, ignoreEditorOnly)
end

function ScreenEntity:addEntity(newChild)
	local retVal = Polycore.ScreenEntity_addEntity(self.__ptr, newChild.__ptr)
end
...
function ScreenEntity:_onKeyDown(key, charCode)
	local retVal = Polycore.ScreenEntity__onKeyDown(self.__ptr, key, charCode.__ptr)
end

function ScreenEntity:_onKeyUp(key, charCode)
	local retVal = Polycore.ScreenEntity__onKeyUp(self.__ptr, key, charCode.__ptr)
end

function ScreenEntity:getScreenConcatenatedMatrix()
	local retVal =  Polycore.ScreenEntity_getScreenConcatenatedMatrix(self.__ptr)
	if retVal == nil then return nil end
...
function ScreenEntity:onKeyDown(key, charCode)
	local retVal = Polycore.ScreenEntity_onKeyDown(self.__ptr, key, charCode.__ptr)
end

function ScreenEntity:onKeyUp(key, charCode)
	local retVal = Polycore.ScreenEntity_onKeyUp(self.__ptr, key, charCode.__ptr)
end
...
function ScreenEntity:getPositionMode()
	local retVal =  Polycore.ScreenEntity_getPositionMode(self.__ptr)
	return retVal
end
...
function ScreenEntity:setDefaultScreenOptions(snapToPixels)
	local retVal = Polycore.ScreenEntity_setDefaultScreenOptions(self.__ptr, snapToPixels)
end
...
function ScreenEntity:getScreenPosition()
	local retVal =  Polycore.ScreenEntity_getScreenPosition(self.__ptr)
	if retVal == nil then return nil end
	local __c = _G["Vector2"]("__skip_ptr__")
	__c.__ptr = retVal
	return __c
...
function ScreenEntity:getScale2D()
	local retVal =  Polycore.ScreenEntity_getScale2D(self.__ptr)
	if retVal == nil then return nil end
	local __c = _G["Vector2"]("__skip_ptr__")
	__c.__ptr = retVal
	return __c
...
function ScreenEntity:getScreenEntityById(id, recursive)
	local retVal = Polycore.ScreenEntity_getScreenEntityById(self.__ptr, id, recursive)
	if retVal == nil then return nil end
...
function ScreenEntity:getScreenEntitiesByTag(tag, recursive)
	local retVal = Polycore.ScreenEntity_getScreenEntitiesByTag(self.__ptr, tag, recursive)
	if retVal == nil then return nil end
...
function ScreenEntity:getHitbox()
	local retVal =  Polycore.ScreenEntity_getHitbox(self.__ptr)
	if retVal == nil then return nil end
...
function ScreenEntity:setHitbox(width, height)
	local retVal = Polycore.ScreenEntity_setHitbox(self.__ptr, width, height)
end

function ScreenEntity:isDragged()
	local retVal =  Polycore.ScreenEntity_isDragged(self.__ptr)
	return retVal
end

function ScreenEntity:__delete()
	if self then Polycore.delete_ScreenEntity(self.__ptr) end
end
